import numpy as np
from .dao import get_words_from_object_name
from .key_words_generating import cleaned_text
...
class TfidfSearching:
    def __init__(self, corpus, topk, ratio, logger=None):
        """
    ...
    def search_topk_objects(self, text_tokens, name_entities):
